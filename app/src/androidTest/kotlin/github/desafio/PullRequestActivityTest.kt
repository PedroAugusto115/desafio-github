...
import github.desafio.ui.activity.PullRequestActivity
import github.desafio.ui.activity.REPOSITORY_TAG
import github.desafio.ui.activity.RepositoryActivity
import github.desafio.ui.adapter.RepositoryAdapter
...
class PullRequestActivityTest : BaseActivityTest<PullRequestActivity>(PullRequestActivity::class.java, false) {
    ...
    private fun createIntent() : Intent {
        val intent = Intent()
        intent.putExtra(REPOSITORY_TAG, createRepositoryModel())
        return intent
    }
